    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                "IF OBJECT_ID('AbpAuditLogs', 'U') IS NOT NULL DROP TABLE [AbpAuditLogs];"
            );
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImpersonatorUserId = table.Column<Guid>(
                    ...
                    ImpersonatorTenantId = table.Column<Guid>(
                        type: "uniqueidentifier",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationUnitId = table.Column<Guid>(
                        type: "uniqueidentifier",
                        nullable: false
                    ),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
