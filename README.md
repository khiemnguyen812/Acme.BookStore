...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9a740c3b-9fc0-4d8b-ad3a-3793569da5b2
```

> `9a740c3b-9fc0-4d8b-ad3a-3793569da5b2` is the password of the certificate, you can change it to any password you want.
